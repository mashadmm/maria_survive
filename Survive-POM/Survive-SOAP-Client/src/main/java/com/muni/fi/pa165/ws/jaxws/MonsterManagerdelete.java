...
@XmlRootElement(name = "monsterManagerdelete", namespace = "http://ws.pa165.fi.muni.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "monsterManagerdelete", namespace = "http://ws.pa165.fi.muni.com/")
public class MonsterManagerdelete {
