...
@XmlRootElement(name = "monsterManagersave", namespace = "http://ws.pa165.fi.muni.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "monsterManagersave", namespace = "http://ws.pa165.fi.muni.com/")
public class MonsterManagersave {
