...
@XmlRootElement(name = "weaponManagersave", namespace = "http://ws.pa165.fi.muni.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "weaponManagersave", namespace = "http://ws.pa165.fi.muni.com/")
public class WeaponManagersave {
