...
@XmlRootElement(name = "weaponManagerupdate", namespace = "http://ws.pa165.fi.muni.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "weaponManagerupdate", namespace = "http://ws.pa165.fi.muni.com/")
public class WeaponManagerupdate {
