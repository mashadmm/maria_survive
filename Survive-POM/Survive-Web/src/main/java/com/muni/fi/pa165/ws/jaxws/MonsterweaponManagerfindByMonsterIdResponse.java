...
@XmlRootElement(name = "monsterweaponManagerfindByMonsterIdResponse", namespace = "http://ws.pa165.fi.muni.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "monsterweaponManagerfindByMonsterIdResponse", namespace = "http://ws.pa165.fi.muni.com/")
public class MonsterweaponManagerfindByMonsterIdResponse {
