...
@XmlRootElement(name = "monsterweaponManagerfindByWeaponIdResponse", namespace = "http://ws.pa165.fi.muni.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "monsterweaponManagerfindByWeaponIdResponse", namespace = "http://ws.pa165.fi.muni.com/")
public class MonsterweaponManagerfindByWeaponIdResponse {
