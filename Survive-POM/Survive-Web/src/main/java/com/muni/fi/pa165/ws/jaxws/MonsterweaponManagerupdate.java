...
@XmlRootElement(name = "monsterweaponManagerupdate", namespace = "http://ws.pa165.fi.muni.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "monsterweaponManagerupdate", namespace = "http://ws.pa165.fi.muni.com/")
public class MonsterweaponManagerupdate {
